...
const Footer = () => {
  return (
   <footer className="mt-20 w-full text-black border-2 border-white p-4 rounded-xl shadow-xl ">
  <div className=" mx-auto w-full px-6   justify-between gap-12">
    {/* Left */}
    <div className="lg:flex lg:justify-between lg:items-center  gap-3 ">
      <div className="text-2xl font-bold  bg-gradient-to-r from-indigo-600 to-cyan-400 bg-clip-text text-transparent">
        SHIV-AI
      </div>
     <nav className="lg:flex lg:flex-row  flex flex-col items-center gap-4 mb-4 fade-up">
